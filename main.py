...
def parse_arguments():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example usage: python script_name.py --provider openai --model gpt-4o-mini --temperature 0.8 --max-tokens 150 --stream --tts elevenlabs --voice Sarah"
    )
    ...
    parser.add_argument("--tts", type=str, choices=["elevenlabs", "streamelements", "polly"],
                        default=None, help="Enable Text-to-Speech with the specified provider")
    parser.add_argument("--voice", type=str, default="en-US-Wavenet-D",
